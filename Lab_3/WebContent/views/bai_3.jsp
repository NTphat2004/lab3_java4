		...
		<div class="row align-items-center justify-content-center "
			...
			<div class="col-5  ">
				<div class="card bg-white bg-opacity-50 border border-1 ">
					...
					<div class="card-body">
						<form action="/Lab_3/dangky3" method="post" name="fmrdk" enctype="multipart/form-data">
							<div class="row ">
								<div class="col">
									<input type="text"
							...
							<div class="row mt-3">
								<div class="col">
									<input type="date"
										class="form-control border border-black border-1 border-top-0 border-start-0 border-end-0 rounded-0 "
										placeholder="Ngày sinh" required name=birthday
										ng-model="Student.birthday"> <em class="text-danger"
										ng-show="fmrdk.birthday.$invalid">Chọn ngày sinh</em>
								</div>
							</div>
							<div class="row mt-3">
								<div class="col">
								...
								<div class="">
									...
									<div class="form-check form-check-inline">
										<input name="hobbies" class="form-check-input" type="checkbox"
											...
											class="form-check-label" for="inlineCheckbox1">Đọc
											sách</label>
									</div>
									<div class="form-check form-check-inline">
										<input name="hobbies" class="form-check-input" type="checkbox"
											id="inlineCheckbox1" value="Đá bóng"> <label
											class="form-check-label" for="inlineCheckbox1">Đá
											bóng</label>
									</div>
									<div class="form-check form-check-inline">
										<input name="hobbies" class="form-check-input" type="checkbox"
